...
constexpr ErrorCode ErrorCode_MIN = EC_None;
constexpr ErrorCode ErrorCode_MAX = EC_Unspecified;
...
template <> struct is_proto_enum< ::Arp::Services::DataLogger::Services::Grpc::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Arp::Services::DataLogger::Services::Grpc::ErrorCode>() {
  return ::Arp::Services::DataLogger::Services::Grpc::ErrorCode_descriptor();
}
