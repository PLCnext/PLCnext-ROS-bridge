...
#ifndef GOOGLE_PROTOBUF_INCLUDED_SessionState_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_SessionState_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_SessionState_2eproto
...
struct TableStruct_SessionState_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_SessionState_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace Arp {
namespace Services {
...
constexpr SessionState SessionState_MIN = SS_None;
constexpr SessionState SessionState_MAX = SS_Error;
...
template <> struct is_proto_enum< ::Arp::Services::DataLogger::Services::Grpc::SessionState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Arp::Services::DataLogger::Services::Grpc::SessionState>() {
  return ::Arp::Services::DataLogger::Services::Grpc::SessionState_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_SessionState_2eproto
