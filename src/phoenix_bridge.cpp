...
PhoenixBridge::PhoenixBridge(ros::NodeHandle nh)
{
  ...
  if (nh.hasParam("std_msgs/Int64"))
  {
    int64_bridge_.init("std_msgs/Int64", nh);
  }
  if (nh.hasParam("std_msgs/Float64"))
  {
    float64_bridge_.init("std_msgs/Float64", nh);
  }
  if (nh.hasParam("std_msgs/Header"))
  {
    header_bridge_.init("std_msgs/Header", nh);
  }
  // [[[end]]]
